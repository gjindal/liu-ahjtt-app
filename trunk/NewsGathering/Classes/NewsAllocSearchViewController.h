//
//  NewsAllocSearchViewController.h
//  NewsGathering
//
...
@interface NewsAllocSearchViewController : UIViewController<UITextFieldDelegate, UITextViewDelegate,UIActionSheetDelegate,UIAlertViewDelegate,UITableViewDelegate,UITableViewDataSource> {
