...
- (void)start {
    ...
    _fileName = [[NSString stringWithFormat:@"Audio_%@_%@.aif",appDelegate.loginId,[dataFormatter stringFromDate:[NSDate date]], nil] retain];
...
//    _fileName = [[NSString stringWithFormat:@"%@/Audio_%@.caf", storeHelper.baseDirectory, [dataFormatter stringFromDate:[NSDate date]], nil] retain];
    ...
    NSDictionary *recordSettings = [[NSDictionary alloc] initWithObjectsAndKeys:
                                    [NSNumber numberWithFloat: 44100.0/*22050.0*/],                 AVSampleRateKey,
                                    [NSNumber numberWithInt: kAudioFormatAppleIMA4], AVFormatIDKey,
                                    [NSNumber numberWithInt: 1],                         AVNumberOfChannelsKey,
                                    [NSNumber numberWithInt: /*AVAudioQualityMin*/AVAudioQualityMax],         AVEncoderAudioQualityKey,
                                    nil];
