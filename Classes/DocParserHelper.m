...
- (void)parser:(NSXMLParser *)parser didEndElement:(NSString *)elementName 
    ...
    if([elementName isEqualToString:@"flag"]) {
        ...
        if(_currentFlag == kFlag_Contri_UploadFile){
            sel = @selector(uploadFileDidFinished:);
            
        }else if(_currentFlag == kFlag_Contri_Add) {
...
//            [((NSObject *)_delegate) performSelectorOnMainThread:sel withObject:[_info autorelease] waitUntilDone:NO];
